...
const TransactionCardView = () => {
  ...
  return (
    <div className="h-full min-h-screen flex flex-col text-black transition duration-100 delay-0 bg-[var(--neutral-color)] dark:bg-[var(--dark-primary-color)] dark:text-white">
      <TransactionHeader />
      <div className="px-5 flex-1">
        <div className="w-full h-fit py-10 bg-[var(--primary-color)] translate-y-[25%] flex flex-col items-center gap-8 shadow relative rounded-lg dark:bg-[var(--dark-neutral-color)]">
